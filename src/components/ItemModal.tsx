                    ...
                    <div className="space-y-6">
                         {item.lore && item.lore.length > 0 && (
                              <div className="bg-gradient-to-br from-zinc-100/50 to-zinc-100/30 dark:from-zinc-800/50 dark:to-zinc-800/30 rounded-xl p-5 ring-1 ring-black/5 dark:ring-white/5">
                                   <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-200 mb-3">Description</h3>
                         ...
                         {item.enchantments && item.enchantments.length > 0 && (
                              <div className="bg-gradient-to-br from-zinc-100/50 to-zinc-100/30 dark:from-zinc-800/50 dark:to-zinc-800/30 rounded-xl p-5 ring-1 ring-black/5 dark:ring-white/5">
                                   <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-200 mb-3">Enchantments</h3>
                                   <div className="grid grid-cols-2 gap-3">
                                        {item.enchantments.map((ench, i) => (
                                             <div key={i} className="bg-gradient-to-br from-white to-white/80 dark:from-zinc-900 dark:to-zinc-900/80 rounded-lg px-4 py-3 text-sm ring-1 ring-black/5 dark:ring-white/5 hover:ring-black/10 dark:hover:ring-white/10 transition-all duration-200">
