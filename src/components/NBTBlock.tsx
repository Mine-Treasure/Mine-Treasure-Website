    ...
    return (
        <>
            <button
                ...
                type='button'
                className={
                    'flex items-center justify-between p-2 font-medium text-left text-gray-500 border border-b-0 border-gray-400 bg-gray-300 hover:bg-gray-100 transition-all duration-500 mx-auto ' +
                    (isOpen ? 'rounded-t-lg w-[100%]' : 'rounded-lg w-48')
                }
            >
                <span>Show Components</span>
                <svg
                    className={
                        'w-6 h-6 shrink-0 ' + (!isOpen ? 'rotate-180' : '')
                    }
                    fill='currentColor'
                    viewBox='0 0 20 20'
