    ...
    return (
        <div>
            <div
                ...
                className={'inline-block ' + (hasModal && 'cursor-pointer')}
                id={id}
            >
                <Image
                ...
                <span
                    style={{
                        color: item.name ? rarityColors.legendary : 'black',
                    }}
                ...
                {hasModal && (
                    <FontAwesomeIcon
                        height={15}
                        className='align-middle inline-block ml-1 text-gray-500'
                        icon={faArrowUpRightFromSquare}
                    />
                )}
            </div>
            {hasModal && showModal && (
                <StatsModal item={item} setModal={setShowModal}></StatsModal>
            )}
