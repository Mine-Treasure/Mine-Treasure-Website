            ...
            <div className='pt-16'>
                        ...
                        <div className='grid md:grid-cols-2 gap-8'>
                            <div className='bg-white dark:bg-zinc-800 p-8 rounded-xl'>
                                ...
                                <h3 className='text-xl font-semibold mb-4'>
                                    {t('home.why.features.treasures.title')}
                                </h3>
                                <p className='text-zinc-600 dark:text-zinc-400'>
                                    {t(
                                        'home.why.features.treasures.description'
                                    )}
                                </p>
                            </div>
                            ...
                            <div className='bg-white dark:bg-zinc-800 p-8 rounded-xl'>
                                ...
                                <h3 className='text-xl font-semibold mb-4'>
                                    {t('home.why.features.biomes.title')}
                                </h3>
                                <p className='text-zinc-600 dark:text-zinc-400'>
                            ...
                            <div className='bg-white dark:bg-zinc-800 p-8 rounded-xl'>
                                ...
                                <h3 className='text-xl font-semibold mb-4'>
                                    {t('home.why.features.items.title')}
                                </h3>
                                <p className='text-zinc-600 dark:text-zinc-400'>
                            ...
                            <div className='bg-white dark:bg-zinc-800 p-8 rounded-xl'>
                                ...
                                <h3 className='text-xl font-semibold mb-4'>
                                    {t('home.why.features.advancements.title')}
                                </h3>
                                <p className='text-zinc-600 dark:text-zinc-400'>
                                    {t(
                                        'home.why.features.advancements.description'
                                    )}
                                </p>
                            </div>
                        </div>
                ...
                <section className='py-24'>
                    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        ...
                        <div className='grid md:grid-cols-2 gap-8'>
                            {Object.entries(t('home.reviews.testimonials')).map(
                            ...
                            <table className='w-full text-left'>
                                <thead className='bg-zinc-50 dark:bg-zinc-800'>
                                    <tr>
                                        <th className='p-4'>
                                            {t(
                                                'home.compatibility.table.headers.software'
                                            )}
                                        </th>
                                        <th className='p-4'>
                                            {t(
                                                'home.compatibility.table.headers.compatible'
                                            )}
                                        </th>
                                        <th className='p-4'>
                                            {t(
                                                'home.compatibility.table.headers.extra'
                                            )}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody className='divide-y divide-zinc-200 dark:divide-zinc-700'>
                                    {Object.entries(
                                        t('home.compatibility.table.entries')
