...
export default function ItemCard({ item, getItemImage, onClick }: ItemCardProps) {
    ...
    return (
        <div
            ...
            className={`flex items-center gap-3 p-2 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 ${showModal ? 'hover:bg-zinc-50 dark:hover:bg-zinc-700/50 cursor-pointer' : ''
                }`}
        >
